         ...
         <div class="col-8">
            ...
            <ul class="list-group-flush">
               <transition-group enter-active-class="animated fadeInDown"
                  ...
                  <li class="list-group-item h4 d-flex justify-content-between "
                      v-for="(todo,index) in todosFiltered" :key="todo.id" @dblclick="editTodo(todo)">

                     <div class="form-check" v-if="!todo.editing">
                        <input type="checkbox"
                               v-model="todo.completed"
                               class="form-check-input mr-3">
                        <label :class="{'completed': todo.completed}"
                               class=" form-check-label ml-3">{{todo.title}}</label>
                     </div>
                     <div v-else class="">
                        <input type="text"
                               v-focus
                               ...
                               class="ml-4 h4 form-control form-editing " v-model="todo.title">
                     </div>
